<?php
add_action( 'wp_enqueue_scripts', 'visage_scripts' );

function visage_scripts() {
    ...
    wp_enqueue_script( 'hoverIntent', get_template_directory_uri() . '/js/superfish-1.4.8/js/hoverIntent.js');
    ...
    wp_enqueue_script( 'slider', get_template_directory_uri() . '/js/jquery.nivo.slider.js');
